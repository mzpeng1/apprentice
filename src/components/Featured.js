...
function Featured() {
    var data = [
        { topic: "academics", title: "placeholder 1", color: "#F68F2F", link: "/Academics/"},
        { topic: "living", title: "placeholder 2", color: "#696969", link: "/Academics/"},
        { topic: "finance", title: "placeholder 3", color: "#943bf2", link: "/Academics/"},
        { topic: "health", title: "placeholder 4", color: "#f743cc", link: "/Academics/"},
        { topic: "academics", title: "placeholder 5", color: "#F68F2F", link: "/Academics/"},
        { topic: "living", title: "placeholder 6", color: "#696969", link: "/Academics/"},
    ]
    const scroll = () => {
        for (var i = 0; i < 4; i++) {
            data[i] = data[i+1];
